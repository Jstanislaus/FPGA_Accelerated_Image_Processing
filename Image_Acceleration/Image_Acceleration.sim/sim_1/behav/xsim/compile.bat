...
REM
REM Generated by Vivado on Sun Aug 10 16:10:47 +0100 2025
...
echo "xvlog --incr --relax -prj tb_bram_loader_vlog.prj"
call xvlog  --incr --relax -prj tb_bram_loader_vlog.prj -log xvlog.log
