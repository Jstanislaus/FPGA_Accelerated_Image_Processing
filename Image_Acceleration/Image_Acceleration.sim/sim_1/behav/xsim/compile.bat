...
REM
REM Generated by Vivado on Mon Aug 11 20:20:02 +0100 2025
...
echo "xvlog --incr --relax -prj tb_rgb_to_gray_vlog.prj"
call xvlog  --incr --relax -prj tb_rgb_to_gray_vlog.prj -log xvlog.log
